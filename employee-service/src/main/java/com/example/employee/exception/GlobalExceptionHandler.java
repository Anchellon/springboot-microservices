...
import com.example.employee.util.TraceIdUtil;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({DuplicateEmployeeException.class, BusinessRuleViolationException.class, IllegalArgumentException.class})
